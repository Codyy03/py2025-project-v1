...
class SensorDataBuffer:
    ...
    def __init__(self):
        ...
        self.max_history_length = 24 * 2  # Maksymalna liczba odczytów do przechowywania (np. 24 pomiary po 30 min = 12h)
        # Ustawiamy na 48, aby mieć zapas na 24 pomiary + 2 pomiary
    ...
    def get_avg_last_n_readings(self, sensor_id, n_readings):
        ...
        with self.lock:
            ...
            # Upewnij się, że nie próbujemy pobrać więcej niż jest dostępnych
...
class SensorServerGUI:
    ...
    def create_widgets(self):
        ...
        # Zmienione nazwy kolumn, aby odzwierciedlić średnie oparte na liczbie pomiarów
        # UWAGA: Te nazwy są używane jako wewnętrzne identyfikatory kolumn w Treeview.
        columns = ("Wartość", "Jednostka", "Czas", "Srednia_1h_2_pom", "Srednia_12h_24_pom")
        self.tree = ttk.Treeview(self.root, columns=columns, show="headings")
        self.tree.pack(fill="both", expand=True, padx=10, pady=10)

        # Nagłówki kolumn tabeli (to są teksty wyświetlane użytkownikowi)
        ...
        # Używamy wewnętrznych identyfikatorów z krotki 'columns' jako pierwszego argumentu
        self.tree.heading("Srednia_1h_2_pom", text="Średnia z 1h (2 pom.)")
        self.tree.heading("Srednia_12h_24_pom", text="Średnia z 12h (24 pom.)")
        ...
        self.tree.column("Srednia_1h_2_pom", width=160, anchor="center")
        self.tree.column("Srednia_12h_24_pom", width=160, anchor="center")
    ...
    def update_table(self):
        ...
        for sensor_id in updated_sensors:
            ...
            # "Średnia z 1h (2 pomiary)" = średnia z ostatnich 2 pomiarów
            avg_2_readings = self.buffer.get_avg_last_n_readings(sensor_id, 2)

            # "Średnia z 12h (24 pomiary)" = średnia z ostatnich 24 pomiarów
            avg_24_readings = self.buffer.get_avg_last_n_readings(sensor_id, 24)
            ...
            values = (
                ...
                f"{avg_2_readings:.2f}" if avg_2_readings is not None else "N/A",
                f"{avg_24_readings:.2f}" if avg_24_readings is not None else "N/A"
            )
